...
echo 0x00001000 >COMPCTRL0
echo 0x11111111 >ALTCOMPCTRL0
echo 0x0000FFFF >TWBSEL0
echo 0x20000000 >SIGMASK0_3
echo 0x20000000 >SIGCOMP0_3
...
echo 0x00001000 >COMPCTRL4
echo 0x11111111 >ALTCOMPCTRL4
echo 0x0000FFFF >TWBSEL4
echo 0x20000000 >SIGMASK4_3
echo 0x20000000 >SIGCOMP4_3
